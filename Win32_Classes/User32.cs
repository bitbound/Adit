...
namespace Win32_Classes
{
    public static class User32
    {
        ...
        public static uint SendMouseWheel(int deltaY)
        {
            ...
            var union = new User32.InputUnion() { mi = new User32.MOUSEINPUT() { dwFlags = User32.MOUSEEVENTF.WHEEL, dx = 0, dy = 0, time = 0, mouseData = deltaY, dwExtraInfo = GetMessageExtraInfo() } };
